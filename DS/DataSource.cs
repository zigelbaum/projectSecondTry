...
namespace DS
{
    public class DataSource
    {
        ...
        private static void initData()
        {
            ...
            guestRequestsCollection.Add(new GuestRequest() { GuestRequestKey = 10000011, PrivateName = "Avrohom", FamilyName = "Diter", MailAddress = "dit@gmail.com", Status = Enums.GuestRequestStatus.Active, RegistrationDate = new DateTime(2019, 10, 04), EnteryDate = new DateTime(2019, 10, 20), ReleaseDate = new DateTime(2019, 10, 28), Area = Enums.Area.Center, SubArea = "Tel Aviv", Type = Enums.HostingUnitType.Hotel, Adults = 2, Children = 5, Pool = true, Jacuzzi = true, Garden = true, ChildrenAttraction = true, Meals = true, Stars = 4 });
